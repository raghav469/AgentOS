    ...
    <div className="relative min-h-screen bg-[#0a0a0a] flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          >
            Create an account to build your autonomous AI agents.
          </motion.p>
        </div>
        ...
        >
          ...
          <button 
            type="submit"
            disabled={isPending}
            className="w-full bg-teal-500 text-white font-semibold rounded-xl px-5 py-3.5 flex items-center justify-center gap-2 hover:bg-teal-400 transition-colors disabled:opacity-70 disabled:cursor-not-allowed group"
          >
